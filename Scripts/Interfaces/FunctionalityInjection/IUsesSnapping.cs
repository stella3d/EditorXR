...
namespace UnityEditor.Experimental.EditorVR
{
	...
	/// </summary>
	public interface IUsesSnapping : IInjectedFunctionality<IUsesSnappingProvider>
	{
	}

	public interface IUsesSnappingProvider
	{
		/// <summary>
	...
	public static class IUsesSnappingMethods
	{
		...
		/// <param name="pivotMode">The current pivot mode</param>
		/// <returns>Whether the position was set to a snapped position</returns>
		public static bool ManipulatorSnap(this IUsesSnapping @this, Transform rayOrigin, Transform[] transforms, ref Vector3 position, ref Quaternion rotation, Vector3 delta, AxisFlags constraints, PivotMode pivotMode)
		{
			return @this.provider.ManipulatorSnap(rayOrigin, transforms, ref position, ref rotation, delta, constraints, pivotMode);
		}
		...
		/// <param name="targetRotation">The input rotation provided by direct transformation</param>
		/// <returns></returns>
		public static bool DirectSnap(this IUsesSnapping @this, Transform rayOrigin, Transform transform, ref Vector3 position, ref Quaternion rotation, Vector3 targetPosition, Quaternion targetRotation)
		{
			return @this.provider.DirectSnap(rayOrigin, transform, ref position, ref rotation, targetPosition, targetRotation);
		}
		...
		/// </summary>
		/// <param name="rayOrigin">The ray whose state to clear</param>
		public static void ClearSnappingState(this IUsesSnapping @this, Transform rayOrigin)
		{
			@this.provider.ClearSnappingState(rayOrigin);
		}
	}
}
#endif
